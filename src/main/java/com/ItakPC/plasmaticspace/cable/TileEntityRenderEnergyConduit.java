...
public class TileEntityRenderEnergyConduit  extends TileEntitySpecialRenderer {
    ...
    private final ResourceLocation texture = new ResourceLocation(Reference.MOD_ID, "textures/models/conduitEnergy.png");
    ...
    public void drawStraightLine(ForgeDirection direction) {
        ...
        tessellator.startDrawing(GL11.GL_QUADS);
        {
            ...
            tessellator.addVertexWithUV(1 - 11 * pixel / 2, 0, 1 - 11 * pixel / 2, 5 * texturePixel, 5 * texturePixel);
            ...
            tessellator.addVertexWithUV(11 * pixel / 2, 0, 1 - 11 * pixel / 2, 5 * texturePixel, 0 * texturePixel);

            tessellator.addVertexWithUV(11 * pixel / 2, 0, 11 * pixel / 2, 5 * texturePixel, 5 * texturePixel);
            ...
            tessellator.addVertexWithUV(1 - 11 * pixel / 2, 0, 11 * pixel / 2, 5 * texturePixel, 0 * texturePixel);

            tessellator.addVertexWithUV(1 - 11 * pixel / 2, 0, 11 * pixel / 2, 5 * texturePixel, 5 * texturePixel);
            ...
            tessellator.addVertexWithUV(1 - 11 * pixel / 2, 0, 1 - 11 * pixel / 2, 5 * texturePixel, 0 * texturePixel);
