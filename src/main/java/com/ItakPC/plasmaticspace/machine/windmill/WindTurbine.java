...
public class WindTurbine extends BlockContainer {
    ...
    public WindTurbine(Material material) {
        super(Material.iron);
        this.setBlockTextureName("windmill");
    }
    ...
    public void breakBlock(World world, int x, int y, int z, Block block, int metadata){
        if(world.getBlock(x, y+1, z).equals(PlasmaticSpace.blockWindmill)) world.setBlockToAir(x, y + 1, z);
        if(world.getBlock(x, y-1, z).equals(PlasmaticSpace.blockWindmill)) world.setBlockToAir(x, y-1, z);
    }
