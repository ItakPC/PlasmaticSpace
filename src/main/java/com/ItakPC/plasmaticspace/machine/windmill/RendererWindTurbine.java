...
public class RendererWindTurbine extends TileEntitySpecialRenderer {
    ...
    public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float f) {
        ...
        while (tileEntity.getWorldObj().getBlockMetadata(x1, y1, z1) < 7 && tileEntity.getWorldObj().getBlock(x1, y1, z1).equals(PlasmaticSpace.blockWindmill)) {
            y1++;
        }
    ...
    private void drawRotor(TileEntity tileEntity) {
        TileWindTurbine windmill = (TileWindTurbine) tileEntity.getWorldObj().getTileEntity(tileEntity.xCoord, tileEntity.yCoord, tileEntity.zCoord);
